...
public class isoObject_wrap implements isoObject_wrapConstants {
  ...
  public static int encodeMONRMessage(timeval objectTime, CartesianPosition position, SpeedType speed, SWIGTYPE_p_AccelerationType acceleration, short driveDirection, short objectState, short readyToArm, short objectErrorState, String monrDataBuffer, long bufferLength, char debug) {
    return isoObject_wrapJNI.encodeMONRMessage(timeval.getCPtr(objectTime), objectTime, CartesianPosition.getCPtr(position), position, SpeedType.getCPtr(speed), speed, SWIGTYPE_p_AccelerationType.getCPtr(acceleration), driveDirection, objectState, readyToArm, objectErrorState, monrDataBuffer, bufferLength, debug);
  }
