...
![installGooglePlayService](./Images/installGooglePlayService.png)
...
![addGooglePlayService](./Images/addGooglePlayService.png) 
...
![debugSHA1](./Images/debugSHA1.png)
...
![androidAPIKey](./Images/androidAPIKey.png)
...
![loadGoogleMap](./Images/loadGoogleMap.png)
...
![simulatorLocateAircraft](./Images/simulatorLocateAircraft.png)

Click the "locate" button, the following GUI prompt to show the location of the aircraft in the map.

![locateAircraft](./Images/locateAircraft.png)
...
![addWaypoints](./Images/addWaypoints.png)
...
![clearWaypoints](./Images/clearWaypoints.png)
...
![configButton](./Images/configButton.png)
...
![uploadwaypointsLog](./Images/uploadwaypointsLog.png)
...
![startGSTask](./Images/startGSTask.png)
